...
export default function Testimonies() {
  return (
    <div className='resting'>
      ...
      <i class="fa-regular fa-handshake" style={{color:"crimson", fontSize:"3rem"}}></i>
      ...
      <i className="fa-solid fa-money-bill" style={{color:"green", fontSize:"3rem"}}></i>
      ...
      <div className='rest'>
        ...
        <i className="fa-solid fa-house-lock" style={{color:"orangered", fontSize:"3rem"}}></i>
